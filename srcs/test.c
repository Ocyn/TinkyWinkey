...
int main(void)
{
    ...
    SystemParametersInfo(SPI_GETKEYBOARDSPEED, 0, &repeatSpeed, 0);
    
    DWORD delayMs = (repeatDelay + 1) * 250;  // 250ms to 1000ms
    DWORD intervalMs = 400 - (repeatSpeed * 12); // ~400ms to ~30ms
